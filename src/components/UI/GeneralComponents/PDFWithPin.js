...
// import getViewerHtml from "../../../../assets/pdfjs/viewerHTML";
...
fetch("https://www.google.com")
  .then(() => log("Google OK"))
  .catch(e => log("Google FAIL", e.message));

fetch("https://dytjimnn1nskw.cloudfront.net/87dfeb53-8bd1-487b-9615-2270be0d7abd/e628cc56-a43b-4b2d-9d01-9b9cc2d8577b/20260702T094834814Z1mb.pdf", {
  method: "HEAD",
})
.then(r => log("HEAD", r.status))
.catch(e => log("HEAD FAILED", e.message));
...
window.ReactNativeWebView.postMessage(
  JSON.stringify({
    type: "LOG",
    message: "loadPDF called",
  })
);

log("Log is working", "working again")
...
const loadingTask = pdfjsLib.getDocument({
  ...
  pdf = await loadingTask.promise;
        ...
        log("This is the error of pdf", e) 
  }
